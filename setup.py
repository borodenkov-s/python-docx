...
long_description = """
The docx module creates, reads and writes Microsoft Office Word 2007 docx files.  The docx module has the following features:
...
setup(name='docx',
      ...
      packages=["docx"],
      package_data={'docx': ['docx-template/_rels/.*', 'docx-template/docProps/*.*', 'docx-template/word/*.xml', 'docx-template/word/theme/*.*']},
      )
